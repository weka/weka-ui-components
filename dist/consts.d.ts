...
export declare const ZERO_STRING = "0";
...
export declare const SCHEME_CHANGE = "schemeChange";
export declare const DIALOG_STATUSES: {
    readonly SUCCESS: "success";
    readonly ERROR: "error";
};
export declare const TOASTER_DIALOG = "toasterDialog";
export declare const TOASTER_TYPES: {
    readonly TOAST: "toast";
    readonly DIALOG: "dialog";
};
export declare const DOWNLOAD_FAILED = "Download failed";
export declare const DEFAULT_DEBOUNCE_DELAY = 700;
export declare const ENCODING_TYPES: {
    text: string;
    binary: string;
    base64: string;
};
declare const FORMULA_TYPES: {
...
export type Formula = {
    type: typeof FORMULA_TYPES.EQUALS | typeof FORMULA_TYPES.GREATER_THAN | typeof FORMULA_TYPES.LESS_THAN;
    value: number;
} | {
    type: typeof FORMULA_TYPES.RANGE;
    from: number;
    to: number;
};
export declare const FORM_VALIDATIONS: {
    ...
    MATCH_FORMULA: (restrictions: Formula[], customErrorMsg?: string) => (value: number) => string | false;
};
export {};
