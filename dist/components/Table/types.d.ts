import { Column, ColumnDef, FilterFn, Table, HeaderGroup, Cell, Row, ColumnFilter, SortingFn } from '@tanstack/react-table';
import { ApiCallCellOptions, BlocksCellOptions, CapacityCellOptions, DateCellOptions, DefaultCellOptions, IconCellOptions, SwitchCellOptions, StatusCellOptions, IconButtonCellOptions, CopyCellOptions, ApiCallCellName, CapacityCellName, StatusCellName, DateCellName, SwitchCellName, IconCellName, DefaultCellName, IconButtonCellName, BlocksCellName, CopyCellName } from './exports';
import { DateFilterOptions, FilterTypes, MultiSelectFilterOptions, SelectFilterOptions, TextFilterOptions } from './components';
...
declare module '@tanstack/react-table' {
    ...
    interface ColumnMeta<TData, TValue> {
        ...
        cell?: CellDef<TData, TValue, typeof ApiCallCellName, ApiCallCellOptions<TData, TValue>> | CellDef<TData, TValue, typeof CapacityCellName, CapacityCellOptions> | CellDef<TData, TValue, typeof StatusCellName, StatusCellOptions<TData>> | CellDef<TData, TValue, typeof BlocksCellName, BlocksCellOptions<TData>> | CellDef<TData, TValue, typeof DateCellName, DateCellOptions> | CellDef<TData, TValue, typeof CopyCellName, CopyCellOptions> | CellDef<TData, TValue, typeof SwitchCellName, SwitchCellOptions<TData>> | CellDef<TData, TValue, typeof IconCellName, IconCellOptions<TData>> | CellDef<TData, TValue, typeof DefaultCellName, DefaultCellOptions<TData, TValue>> | CellDef<TData, TValue, typeof IconButtonCellName, IconButtonCellOptions<TData>>;
        columnTitle?: string;
        _type?: 'column' | 'action';
    }
}
