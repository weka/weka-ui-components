...
declare const utils: {
    ...
    toastError: (err?: string | Error | unknown, showDialog?: boolean) => void;
    toastSuccess: (message: string, showDialog?: boolean) => void;
    ...
    formatBytes: (bytes: number, decimals?: number, k?: number) => {
        value: number;
        text: string;
    } | {
        value: string;
