...
import { TOASTER_TYPES } from './consts.ts';
...
declare const utils: {
    ...
    formatIconStringOption: ({ value, label, icon }: {
        value: string | number;
        label: string;
    ...
    closeDialogOnEscape(reason: any, func: any): void;
    downloadFile(content: string | Blob, fileName: string, type?: (typeof MIME_TYPES)[keyof typeof MIME_TYPES], shouldStringify?: boolean): void;
};
