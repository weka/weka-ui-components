...
describe('Button', () => {
  ...
  describe('Rendering', () => {
    ...
    it('renders without rounded style by default', () => {
      const { container } = render(<Button>Click me</Button>)
      const button = container.querySelector('button')
      expect(button?.className).not.toContain('isRounded')
    })

    it('renders with rounded style when isRounded is true', () => {
      const { container } = render(<Button isRounded>Click me</Button>)
      const button = container.querySelector('button')
